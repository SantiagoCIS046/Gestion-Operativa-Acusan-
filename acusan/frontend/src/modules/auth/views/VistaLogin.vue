          ...
          <form @submit.prevent="handleLogin" class="login-form" novalidate>
            ...
            <div class="field-group" :class="{ 'field-error': errores.password }">
              ...
              <div class="field-input-wrapper">
                ...
                >
                  <svg v-if="!mostrarPassword" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <template v-else-if="modo === 'registro'">
          ...
          <form @submit.prevent="handleRegistro" class="login-form compact" novalidate>
            ...
            <div class="field-group">
              ...
              <input v-model="formRegistro.password" type="password" class="field-input" placeholder="Mínimo 6 caracteres" required />
            </div>
        ...
        <template v-else-if="modo === 'reset-password'">
          ...
          <form @submit.prevent="handleResetearPassword" class="login-form" novalidate>
            ...
            <div class="field-group">
              ...
              <input v-model="formReset.nuevaPassword" type="password" class="field-input" placeholder="Mínimo 6 caracteres" required />
            </div>

            <!-- Confirmar Contraseña -->
            <div class="field-group">
              <label class="field-label">Confirmar Nueva Contraseña</label>
              <input v-model="formReset.confirmarPassword" type="password" class="field-input" placeholder="Repita la clave" required />
            </div>
...
.toggle-password:hover { color: #004884; background: #f1f5f9; }
